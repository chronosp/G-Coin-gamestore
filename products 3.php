  ...
  $n++;
	...
	?>		
        ...
        <div class="footer">
          <ul class="pages">
            <li>
              <a href="products 2.php" class="page-num left-btn"> < </a>
            </li>
            <li>
              <a href="products.php" class="page-num">1</a>
            </li>
            <li>
              <a href="products 2.php" class="page-num">2</a>
            </li>
            <li>
              <a href="products 3.php" class="page-num is_active">3</a>
            </li>
            <li>
              <a href="products.php" class="page-num"> > </a>
            </li>
          </ul>
        </div>
        </center> 
